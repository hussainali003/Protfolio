...
export default function SkillsChat() {
    return (
        <div className="flex flex-col h-full text-sm px-4 pt-2 pb-6 text-slate-300  overflow-y-auto scrollbar-thin scrollbar-thumb-gray-500 scrollbar-track-gray-900 hover:scrollbar-thumb-gray-400">
