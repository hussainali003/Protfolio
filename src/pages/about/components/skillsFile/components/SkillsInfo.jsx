...
export default function SkillsInfo() {
    return (
        <div className="w-[400px] min-w-[400px] flex flex-col h-full text-sm text-slate-300">
            <div className='h-[44px] flex px-4 border-b border-b-line'>
            </div>
            <div className='flex flex-col h-full px-4 pt-2 pb-6 overflow-y-auto scrollbar-thin scrollbar-thumb-gray-500 scrollbar-track-gray-900 hover:scrollbar-thumb-gray-400'>
